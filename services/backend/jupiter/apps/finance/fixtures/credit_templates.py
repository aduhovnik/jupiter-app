...
CREDIT_TEMPLATES = [
...

    {
        ...
        "detailed_info":"Максимальная и минимальная сумма кредиты определяются на основании стоимости автомобиляю.\n"
                        "Автоматически переводит деньги "
                        "на счет продавца.\nКак способ обеспечения вы можете "
