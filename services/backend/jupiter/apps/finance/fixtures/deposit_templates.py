...
DEPOSIT_TEMPLATES = [
    {
        ...
        "detailed_info": "Срок вклада составляет 3 месяца. \n"
                         "Оформление происходит онлайн. Вы указываете счет, с которого будут списаны средства."
                         ...
                         "Отозвать деньги вы можете в любой момент. Для чего вы должны указать счет, на который"
                         "будут переведены деньги. Либо посетить отделение банка.\n"
    },

    {
        "name": "Карпо",
        "description": "Срочный безотзывный банковский вклад с квартальной капитализацией и лонгированияем.",
        "currency": {
            "BYN": {
                "min_amount": 200,
                "max_term": 36,
        ...
        "detailed_info": "Срок вклада составляет до 36 месяца. \n"
                         ...
                         "После подтверждения администратором со счета снимут указанную сумму, "
                         "а счет вновь станет активным.\n"
                         "Отозвать деньги вы можете только в конце срока вклада (начиная за неделю до конца)."
    ...
    {
        "name": "Фива",
        "description": "Срочный безотзывной банковский вклад с месячной капитализацией и без лонгирования.",
        "currency": {
            "BYN": {
                "min_amount": 100,
                "max_term": 32,
